                ...
                <div className="bottom-0 top-[118px] flex w-full flex-col gap-5 self-start overflow-y-hidden lg:sticky" id="left-carousel">
                    ...
                    <div className="ml-[68px]">
                        <div className="relative flex items-center justify-between bg-white">
                            <div className="pointer-events-none w-0 -translate-x-8 opacity-0" style={{transform: "translateX(-10px)", width: "0%", opacity: "0"}}>
                                <div className="flex items-center gap-2 shrink-0" data-discountpercent="87" data-getforpassprice="5700">
                                    <p className="text-[24px] font-medium leading-5 text-[#262A33]">₹57</p>
                                    <p className="text-[16px] font-[450] leading-[21.6px] tracking-[-0.24px] text-[#A9B0C2] line-through">₹469</p>
                                </div>
                            </div>
                            <div aria-label="Add to Cart" className="flex h-12 justify-between overflow-hidden rounded-[10px] border border-[#EF4372] bg-[#EF4372] px-4 py-3 font-bold leading-5 tracking-[0.1px] text-white transition-all duration-300 ease-in-out w-full" style={{width: "100%"}}>
