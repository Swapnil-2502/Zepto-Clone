      ...
      >
        <div className="flex items-center gap-x-3 p-5 lg:gap-x-6 lg:px-16">
          ...
          <div className="inline-block flex-1">
            ...
            >
              <svg fill="none" height="18px" viewBox="0 0 15 15" width="18px" xmlns="http://www.w3.org/2000/svg">
                  <path clip-rule="evenodd" d="M2 6.5C2 4.01472 4.01472 2 6.5 2C8.98528 2 11 4.01472 11 6.5C11 8.98528 8.98528 11 6.5 11C4.01472 11 2 8.98528 2 6.5ZM6.5 1C3.46243 1 1 3.46243 1 6.5C1 9.53757 3.46243 12 6.5 12C9.53757 12 12 9.53757 12 6.5C12 3.46243 9.53757 1 6.5 1ZM11.2669 10.4068C11.0773 10.206 10.7609 10.1969 10.5601 10.3864C10.3593 10.576 10.3502 10.8924 10.5397 11.0932L13.1368 13.8442C13.3264 14.045 13.6428 14.0541 13.8436 13.8646C14.0444 13.675 14.0535 13.3585 13.864 13.1577L11.2669 10.4068Z" fill="#383837" fill-rule="evenodd" style={{height: "18px", width: "18px", color: "rgb(56, 56, 55)"}}></path>
          ...
          <div className="inline-block">
            <button className="cursor-pointer" aria-label="login" type="button" onClick={() => setIsLoginOpen(true)}>
              ...
              <svg fill="none" height="24px" viewBox="0 0 26 26" width="24px" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="12.5" cy="11.168" r="3.5" stroke="#000000" stroke-linecap="round" stroke-width="1.6"></circle>
                  <circle cx="12.5" cy="13.5" r="10.5" stroke="#000000" stroke-width="1.6"></circle>
                ...
                <span className="text-sm capitalize text-black">login</span>
              </div>
            </button>
          </div>
