...
const Dummy = () => {
  return (
    <>
        <a href="/pn/vietnamese-cold-coffee/pvid/6a09750b-2bb7-4d1b-90f9-cd2a66269bfd">
            <div className="_container_sm_c1j8m_22 _container_c1j8m_3" data-variant="basic" data-size="sm" data-device="desktop" data-is-out-of-stock="false" style={{backgroundColor: "white"}}>
                <div data-slot-id="ProductImageWrapper" className="_container_6hrif_1 _image-wrapper_c1j8m_32">
                    <div className="_base_shgav_2 _base_border_shgav_13 _product-image--sm_c1j8m_40">
                        <img alt="Vietnamese Cold Coffee" title="Vietnamese Cold Coffee" className="_image_shgav_18" loading="lazy" src="https://cdn.zeptonow.com/production/tr:w-1280,ar-5304-5304,pr-true,f-auto,q-80/cms/product_variant/9bc896d4-229d-45a4-8294-b36f97f5992c.jpeg"/>
                ...
                <div className="_price-and-discount-attribute_c1j8m_50">
                    <div data-slot-id="Price" className="_base_ljyvk_2 _price-container_c1j8m_58">
                        ...
                        <p className="_original-price_ljyvk_35"><span className="_currency-symbol_ljyvk_49">₹</span>529</p>
                    </div>
                    <div className="_base_oilfk_1"><span>SAVE</span><span>₹416</span></div>
                </div>
                <div data-slot-id="PackSize" className="_base_4i17o_1 _pack-size-container_c1j8m_64"><span>450 ml</span></div>
                <div data-clamp="2" data-slot-id="ProductName" className="_base_1i8oq_1 _product-name-container_c1j8m_76"><span>Vietnamese Cold Coffee</span></div>
